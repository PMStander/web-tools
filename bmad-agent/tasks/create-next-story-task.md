...
- **MANDATORY**: Create and SAVE a new story file: `docs/stories/{epic-num}.{story-num}.story.md` (using BMAD standard naming with hyphens).
- **VERIFICATION**: Confirm the file has been created and saved, not just output to chat.
